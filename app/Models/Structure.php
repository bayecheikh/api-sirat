...
class Structure extends Model
{
   ...
   */
  protected $fillable = [
    'nom_structure','donneur_receveur_mixte','numero_autorisation','accord_siege','numero_agrement','adresse_structure','debut_intervention','fin_intervention','telephone_structure','email_structure','status'
  ];
